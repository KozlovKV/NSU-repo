...
**О.** $P(\vec{x})$ - примитивно рекурсивный предикат, если $h_p(\vec{x})$ - ПРФ

Повторим соотношение классов функций: ПРФ $\subset$ ВФ $\subset$ ЧВФ

$A \subseteq \N^k$ - вычислимое множество (либо ПРФ), если его $h_A(\vec{x})$ - вычислимая характеристическая функция (либо ПРФ). Определяется эта характеристическая функция таким же образом