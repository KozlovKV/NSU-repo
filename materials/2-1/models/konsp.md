...
## Частичная функция
Частичная функция $f$ называется **частично вычислимой функцией** (ЧВФ), если принадлежит наименьшему классу, содержащему простейшие функции и замкнутому относительно суперпозиции, примитивной рекурсии и иминимизации
...
Канторовская нумерация `C(x, y)` отображает $\n^2$ в $\N$ и делает это биективно 

Рядами в поле таких чисел будут номероваться по побочным диагоналям, начиная обход с верхнего левого угла.
