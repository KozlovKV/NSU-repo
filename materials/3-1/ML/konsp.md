...
Говоря человечески, матожидание риска k-fold кросс-валдиации будет равно матожиданию риска для выборки, из которой мы исключили число элементов, содержащееся в одном фолде
