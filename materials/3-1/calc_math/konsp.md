...
- [Лекция 7](#лекция-7)
  - [Численное интегрирование](#численное-интегрирование)
    ...
    - [Полином Лежандра для выбора сетки](#полином-лежандра-для-выбора-сетки)
...
### Полином Лежандра для выбора сетки
**Полином Лежандра**:
$$
...
**Т.** Если для интерполяционной квадратуры взяты точки, являющиеся корнями полинома Лежандра, то квадратура будет точна для полиномов степени $\le 2N - 1$