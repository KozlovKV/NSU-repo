...
## Лямбда-функции
Лямбда-функция на самом деле - реализация одного метода `calculate` для соответствующего класса лямбда-функции. В качестве синтаксического сахара добавлена следующая нотация:
```java
