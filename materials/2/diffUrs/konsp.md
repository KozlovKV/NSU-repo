...
# 23.09.14 - лекция
*В начале идёт материал с семинара*

## Линейные дифференциальные уравнения
**О.** Диффуры первого порядка вида $y' = p(x)y + q(x)$ называются **линейными диффурами первого порядка**

Метод решения:
1. Решаем уравнение, где рассматриваем $q(x) \equiv 0$
2. И получаем простое разделённое диффуравнение
3. Для $q(x) \not= 0$
   1. *Дописать*
