...
Стратегия first fit и алгоритм парных меток. (комментарий от Антона - лучше упомянуть, что такая реализация malloc-а в GNU LibC до 2010 года)
