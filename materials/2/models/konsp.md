...
- L(N) - по пустому магазину - слово распознается, если в результате его прохода мы получили пустой магазин, то есть даже без знака дна, который был при этом удалён последним
