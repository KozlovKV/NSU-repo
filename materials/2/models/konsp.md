...
Самый распространённый вариант перехода - замена верхнего символа на слово. В таком случае весь переход будет записываться как $a, X / \alpha$ - переход по символу "а" с заменой символа со X со стэка на слово альфе (на верну стэка будет первый символ альфа)
...
- L(N) - по пустому магазину - слово распознается, если в результате его прохода мы получили пустой магазин