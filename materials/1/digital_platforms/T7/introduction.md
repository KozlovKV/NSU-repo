...
Здесь ещё добавлю только, что мы используем версию <a href="./CdM-8-mark5-full.circ" download>CdM-8-mark5</a>, а в лекциях показана mark4. Отличия у них не слишком большие, но выглядеть наш чип будет немного иначе - ничего страшного (*обидно разве что, что инпут `reset` пропал*)
