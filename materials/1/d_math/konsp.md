...
Жадный алгоритм для покраски вершин - берём произвольную вершину и красим в минимально допустимый цвет. Гарантированно окрашивает граф в `<= delta + 1` цветов

Гарантированный алгоритм - перебор по алгоритму **connection contraction**:
1. На место отсутствующего ребра по одной из веток добавляется ребро, а по другой - вершины на конце несуществующего ребра стягиваются. 