...
- [23.04.06 - семинар](#230406---семинар)
  - [Поиск компонетнов сильной связности](#поиск-компонетнов-сильной-связности)
...
## Чем полезен DFS
### Топологическая сортировка
Проводится при помощи DFS с учётом времени выхода. Далее сортируем вершины по убыванию по времени выхода и получаем топологически отсортированный массив вершин. Также можно вместо присвоения моменн=та выхода сразу складывать вершины в топологоичски отсортированный массив в момент выхода из этих вершин.
...
# 23.04.06 - семинар
## Поиск компонетнов сильной связности
