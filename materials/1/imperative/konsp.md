...
# 22.11.26 - лекция
## Hash-таблицы
Hash-таблица – хранит ключи в ячейке с индексом, равным хэшу от ключа.

Для разрешения коллизий есть 2 варианта:
1. В каждой ячейке хранится список
2. Если ячейка занята, то двигаемся вправо до первой свободной
