...
- [22.10.31 - seminar](#221031---seminar)
  - [More base class types](#more-base-class-types)
...
Классическая рекурсия обычно движется вверх (<code>n+1</code>), тогда как ко-рекурсия движется вниз (<code>n+1</code>). В таком случае необходимо тщательно следить за условиями выхода
</blockquote>
---
...
# 22.10.31 - seminar
## More base class types
- `Bounded` - sequence with min and max values
- `Maybe`
...
- Побочный эффект - функция кроме возврата значения делает что-то ещё
