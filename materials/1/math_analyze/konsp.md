...
- [23.02.01 - лекция](#230201---лекция)
  ...
  - [Операции на кватернионами](#операции-на-кватернионами)
...
$g = t + xi + yj +zk$, где $i, j, k$ - кватернионные единицы

## Операции на кватернионами
Сложение работает также, как и с комплексными числами

Для умножения есть особая таблиц
...
3. Дистрибутивность для сложения в скобках и умножения вне них.
...
Ядро линейного оператора (*далее* **ЛО**): $\{ x \in X | a(x) = 0 \}$

Образ ЛО: $\{ y \in X | a(x) = y \}$
